...
public class Main {
    ...
    // // ResponsablePedagogique savedResponsable =
    // service.createResponsable(responsable);
    // // System.out.println("Responsable créé avec succès ! ID : " +
    // savedResponsable.getId());
    // // } catch (Exception e) {
    ...
    // // System.out.println("Authentification : " + (connexion ? "Réussie" :
    // "Échec"));
