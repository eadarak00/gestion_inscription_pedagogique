...
public class NotificationCardStudentFrame extends JFrame {
    ...
    private final EtudiantService rService;
    private final NotificationService notificationService;

    public NotificationCardStudentFrame() {
        ...
        this.rService = new EtudiantService();
        this.notificationService = new NotificationService();
        this.etudiant = this.rService.getEtudiantById(user.getId());
    ...
    private void loadNotificationsFromDatabase() {
        try {
            ...
            notifications = notificationService.recupererNotifications(etudiant.getEmail());
